...
class UserModuleContentQuery(BaseQuery):
    ...
    def get_user_module_content(self, user_program_id, program_module_id, module_content_id):
        return self.filter(UserModuleContent.user_program_id == user_program_id, UserModuleContent.program_module_id == program_module_id, UserModuleContent.module_content_id == module_content_id).first()
